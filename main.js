 ...
 * @return {string} (ipv6Address) - An IPv6 address.
 */
  ...
  constructor() {
    ...
    getFirstIpAddress(cidrStr, callback) {
      ...
      if (!cidr.isValid()) {
        ...
        // Get V6 of firstIpAddress
        ipv6Address = getIpv4MappedIpv6Address(firstIpAddress);
      }
      // Call the passed callback function.
      // Node.js convention is to pass error data as the first argument to a callback.
      // The IAP convention is to pass returned data as the first two argument and error
      // data as the third argument to the callback function.
